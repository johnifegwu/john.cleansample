...
To update the database use this command from the Web project folder (replace `john.cleansample` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../john.cleansample.Infrastructure/john.cleansample.Infrastructure.csproj -s john.cleansample.Web.csproj
```
